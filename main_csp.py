...
REVIEWS_MENU = [["✍🏻оставить отзыв✍🏻", "👀посмотреть отзывы👀"], ["🔙вернуться обратно🔙", "🐒позвать Sofia🐒"]]
FINISH_TALKING = ["🏁я закончил🏁", "🐒позвать Sofia🐒"]  # в некоторых упражнениях требуется написать, что ты закончил его
